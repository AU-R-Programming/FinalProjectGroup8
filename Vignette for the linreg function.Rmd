...
* The function appears as my_lm in the R code file and is accompanied by a help file:
my_lm = function(y, x, alpha, approach) which can be accessed by any user.
...
* After attaching the dataset, the user would first state the sample size, then set up the y and x values as follows: 
